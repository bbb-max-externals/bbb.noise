...
class bbb_noise_fbm : public c74::min::object<bbb_noise_fbm> {
public:
	MIN_DESCRIPTION{"Fractal Brownian Motion noise generator"};
	MIN_TAGS{"noise, fbm, fractal, procedural"};
	MIN_AUTHOR{"2bit"};
