{
  "patcher" : {
    ...
    "enablevscroll" : 1,
    "devicewidth" : 0.0,
    "description" : "Turbulence noise (abs-sum fractal)",
    "digest" : "bbb.noise.turbulence - Turbulence noise generator",
    "tags" : "noise, turbulence, fractal, procedural",
    "style" : "",
    "subpatcher_template" : "",
    ...
    "boxes" : [
      ...
      },
      {
        "box" : {
          ...
          "text" : "Turbulence noise. Sum of absolute values of octaves."
        }
      },
      {
        "box" : {
