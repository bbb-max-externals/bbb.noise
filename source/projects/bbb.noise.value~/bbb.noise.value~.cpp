...
class bbb_noise_value_tilde : public c74::min::object<bbb_noise_value_tilde>, public c74::min::mc_operator<> {
public:
	MIN_DESCRIPTION{"Value noise signal generator"};
	MIN_TAGS{"noise, value, procedural, audio"};
	MIN_AUTHOR{"2bit"};
...
private:
	bbb::noise::evaluator eval_{bbb::noise::config{bbb::noise::type::value, 0}};
};

MIN_EXTERNAL(bbb_noise_value_tilde);
