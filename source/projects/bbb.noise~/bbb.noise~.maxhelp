    ...
    "boxes" : [
      ...
      },
      {
        "box" : {
          ...
          "numinlets" : 1,
          "numoutlets" : 0,
          "patching_rect" : [50.0, 55.0, 380.0, 20.0],
          "text" : "All-in-one procedural noise signal generator (MC support)"
        }
      },
      {
        "box" : {
      ...
      },
      {
        "box" : {
          ...
          "text" : "bbb.noise~ @input_dim 1 @basis perlin"
        }
      },
      {
        "box" : {
      ...
      },
      {
        "box" : {
          ...
          "numinlets" : 1,
          "numoutlets" : 0,
          "patching_rect" : [50.0, 675.0, 550.0, 20.0],
          "text" : "@basis (symbol, default: perlin) — perlin / simplex / value / cellular / fbm / turbulence / ridged"
        }
      },
      {
        "box" : {
          ...
          "text" : "@source (symbol, default: simplex) — Basis for fractal: perlin / simplex / value"
        }
      },
      {
        "box" : {
      ...
      },
      {
        "box" : {
          ...
          "numinlets" : 1,
          "numoutlets" : 0,
          "patching_rect" : [50.0, 775.0, 450.0, 20.0],
      ...
      },
      {
        "box" : {
          ...
          "numinlets" : 1,
          "numoutlets" : 0,
          "patching_rect" : [50.0, 800.0, 450.0, 20.0],
          "text" : "@cellular_mode (symbol, default: f1) — f1 / f2 / f2minusf1 / id"
        }
      }
    ],
    "lines" : [
