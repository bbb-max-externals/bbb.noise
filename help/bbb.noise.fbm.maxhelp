{
  "patcher" : {
    ...
    "digest" : "bbb.noise.fbm - Fractal Brownian Motion noise generator",
    "tags" : "noise, fbm, fractal, procedural",
    "style" : "",
    "subpatcher_template" : "",
    ...
    "boxes" : [
      ...
      },
      {
        "box" : {
          ...
          "text" : "Fractal Brownian Motion noise. Sum of octaves with amplitude decay."
        }
      },
      {
        "box" : {
      ...
      },
      {
        "box" : {
          ...
          "numoutlets" : 1,
          "outlettype" : [""],
          "patching_rect" : [50.0, 430.0, 130.0, 22.0],
          "text" : "bbb.noise.fbm"
        }
      },
      {
        "box" : {
          ...
          "numoutlets" : 1,
          "outlettype" : [""],
          "patching_rect" : [210.0, 430.0, 60.0, 22.0]
        }
      },
      {
        "box" : {
