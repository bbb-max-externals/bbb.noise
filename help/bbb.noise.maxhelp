{
  "patcher" : {
    ...
    "enablevscroll" : 1,
    "devicewidth" : 0.0,
    "description" : "All-in-one noise (select algorithm via @basis)",
    "digest" : "bbb.noise - All-in-one noise generator with selectable basis",
    "tags" : "noise, perlin, simplex, value, cellular, fbm, turbulence, ridged, procedural",
    "style" : "",
    "subpatcher_template" : "",
    ...
    "boxes" : [
      ...
      },
      {
        "box" : {
          ...
          "text" : "All-in-one noise generator. Select algorithm via @basis attribute."
        }
      },
      {
        "box" : {
      ...
      },
      {
        "box" : {
          ...
          "numoutlets" : 1,
          "outlettype" : [""],
          "patching_rect" : [200.0, 430.0, 60.0, 22.0]
        }
      },
      {
        "box" : {
      ...
      },
      {
        "box" : {
          ...
          "text" : "@basis: noise algorithm - perlin/simplex/value/cellular/fbm/turbulence/ridged (default: perlin)"
        }
      },
      {
        "box" : {
      ...
      },
      {
        "box" : {
          ...
          "numinlets" : 1,
          "numoutlets" : 0,
          "patching_rect" : [50.0, 640.0, 500.0, 20.0],
      ...
      },
      {
        "box" : {
          ...
          "text" : "@cellular_mode: distance function - f1/f2/f2minusf1/id (default: f1) [cellular only]"
        }
      },
      {
        "box" : {
          ...
          "text" : "@source: basis noise type - perlin/simplex/value (default: simplex) [fractal only]"
        }
      },
      {
        "box" : {
          ...
          "text" : "@octaves: number of fractal layers 1-8 (default: 4) [fractal only]"
        }
      },
      {
        "box" : {
          ...
          "numinlets" : 1,
          "numoutlets" : 0,
          "patching_rect" : [50.0, 750.0, 500.0, 20.0],
          "text" : "@gain: amplitude decay per octave 0-1 (default: 0.5) [fractal only]"
        }
      },
      {
        "box" : {
          ...
          "numinlets" : 1,
          "numoutlets" : 0,
          "patching_rect" : [50.0, 775.0, 500.0, 20.0],
          "text" : "@lacunarity: frequency multiplier per octave >0 (default: 2.0) [fractal only]"
        }
      }
    ],
    "lines" : [
