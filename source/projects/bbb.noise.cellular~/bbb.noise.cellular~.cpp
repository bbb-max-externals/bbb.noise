...
class bbb_noise_cellular_tilde : public c74::min::object<bbb_noise_cellular_tilde>, public c74::min::mc_operator<> {
public:
	MIN_DESCRIPTION{"Cellular (Worley) noise signal generator"};
	MIN_TAGS{"noise, cellular, worley, procedural, audio"};
	MIN_AUTHOR{"2bit"};
...
MIN_EXTERNAL(bbb_noise_cellular_tilde);
