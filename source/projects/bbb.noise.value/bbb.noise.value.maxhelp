{
  "patcher" : {
    ...
    "enablevscroll" : 1,
    "devicewidth" : 0.0,
    "description" : "Value/lattice noise (1D-4D)",
    "digest" : "bbb.noise.value - Value/lattice noise generator",
    "tags" : "noise, value, procedural",
    "style" : "",
    "subpatcher_template" : "",
    ...
    "boxes" : [
      ...
      },
      {
        "box" : {
          ...
          "text" : "Value/lattice noise generator (1D-4D). Event-rate output."
        }
      },
      {
        "box" : {
