{
  "patcher" : {
    ...
    "enablevscroll" : 1,
    "devicewidth" : 0.0,
    "description" : "Perlin gradient noise (1D-4D)",
    "digest" : "bbb.noise.perlin - Perlin gradient noise generator",
    ...
    "boxes" : [
      ...
      },
      {
        "box" : {
          ...
          "text" : "Perlin gradient noise generator (1D-4D). Event-rate output."
        }
      },
      {
        "box" : {
