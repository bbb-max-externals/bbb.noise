{
  "patcher" : {
    ...
    "enablevscroll" : 1,
    "devicewidth" : 0.0,
    "description" : "Simplex noise (1D-4D)",
    "digest" : "bbb.noise.simplex - Simplex noise generator",
    "tags" : "noise, simplex, procedural",
    "style" : "",
    "subpatcher_template" : "",
    ...
    "boxes" : [
      ...
      },
      {
        "box" : {
          ...
          "text" : "Simplex noise generator (1D-4D). Event-rate output."
        }
      },
      {
        "box" : {
