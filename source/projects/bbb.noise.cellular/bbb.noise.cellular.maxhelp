{
  "patcher" : {
    ...
    "enablevscroll" : 1,
    "devicewidth" : 0.0,
    "description" : "Cellular/Worley noise (F1, F2, F2-F1, ID)",
    "digest" : "bbb.noise.cellular - Cellular/Worley noise generator",
    "tags" : "noise, cellular, worley, procedural",
    "style" : "",
    "subpatcher_template" : "",
    ...
    "boxes" : [
      ...
      },
      {
        "box" : {
          ...
          "text" : "Cellular/Worley noise generator (F1, F2, F2-F1, ID). Event-rate output."
        }
      },
      {
        "box" : {
      ...
      },
      {
        "box" : {
          ...
          "numoutlets" : 1,
          "outlettype" : [""],
          "patching_rect" : [50.0, 430.0, 160.0, 22.0],
          "text" : "bbb.noise.cellular"
        }
      },
      {
        "box" : {
          ...
          "numoutlets" : 1,
          "outlettype" : [""],
          "patching_rect" : [240.0, 430.0, 60.0, 22.0]
        }
      },
      {
        "box" : {
      ...
      },
      {
        "box" : {
          ...
          "text" : "@cellular_mode: distance function - f1/f2/f2minusf1/id (default: f1)"
        }
      }
    ],
    "lines" : [
