...
class bbb_noise_value : public c74::min::object<bbb_noise_value> {
public:
	MIN_DESCRIPTION{"Value noise generator"};
	MIN_TAGS{"noise, value, procedural"};
	MIN_AUTHOR{"2bit"};
