...
class bbb_noise_ridged_tilde : public c74::min::object<bbb_noise_ridged_tilde>, public c74::min::mc_operator<> {
public:
	MIN_DESCRIPTION{"Ridged multifractal noise signal generator"};
	MIN_TAGS{"noise, ridged, fractal, procedural, audio"};
	MIN_AUTHOR{"2bit"};
...
MIN_EXTERNAL(bbb_noise_ridged_tilde);
