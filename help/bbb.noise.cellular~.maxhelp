    ...
    "boxes" : [
      ...
      },
      {
        "box" : {
          ...
          "text" : "Cellular (Worley) noise signal generator (MC support)"
        }
      },
      {
        "box" : {
      ...
      },
      {
        "box" : {
          ...
          "numoutlets" : 1,
          "outlettype" : ["signal"],
          "patching_rect" : [50.0, 285.0, 230.0, 22.0],
          "text" : "bbb.noise.cellular~ @input_dim 1"
        }
      },
      {
        "box" : {
          ...
          "numoutlets" : 1,
          "outlettype" : [""],
          "patching_rect" : [320.0, 270.0, 70.0, 22.0],
          "text" : "seed 42"
        }
      },
      {
        "box" : {
          ...
          "numoutlets" : 1,
          "outlettype" : [""],
          "patching_rect" : [320.0, 300.0, 70.0, 22.0],
          "text" : "randomize"
        }
      },
      {
      ...
      },
      {
        "box" : {
          ...
          "numinlets" : 1,
          "numoutlets" : 0,
          "patching_rect" : [50.0, 675.0, 450.0, 20.0],
