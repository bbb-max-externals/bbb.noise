    ...
    "boxes" : [
      ...
      },
      {
        "box" : {
          ...
          "text" : "Perlin noise signal generator (MC support)"
        }
      },
      {
        "box" : {
      ...
      },
      {
        "box" : {
          ...
          "numoutlets" : 1,
          "outlettype" : ["signal"],
          "patching_rect" : [50.0, 285.0, 220.0, 22.0],
          "text" : "bbb.noise.perlin~ @input_dim 1"
        }
      },
      {
        "box" : {
          ...
          "numoutlets" : 1,
          "outlettype" : [""],
          "patching_rect" : [310.0, 270.0, 70.0, 22.0],
          "text" : "seed 42"
        }
      },
      {
        "box" : {
          ...
          "numoutlets" : 1,
          "outlettype" : [""],
          "patching_rect" : [310.0, 300.0, 70.0, 22.0],
          "text" : "randomize"
        }
      },
      {
