    ...
    "boxes" : [
      ...
      },
      {
        "box" : {
          ...
          "numinlets" : 1,
          "numoutlets" : 0,
          "patching_rect" : [50.0, 55.0, 360.0, 20.0],
          "text" : "Value (lattice) noise signal generator (MC support)"
        }
      },
      {
        "box" : {
      ...
      },
      {
        "box" : {
          ...
          "numoutlets" : 1,
          "outlettype" : ["signal"],
          "patching_rect" : [50.0, 285.0, 210.0, 22.0],
          "text" : "bbb.noise.value~ @input_dim 1"
        }
      },
      {
        "box" : {
          ...
          "numoutlets" : 1,
          "outlettype" : [""],
          "patching_rect" : [300.0, 270.0, 70.0, 22.0],
          "text" : "seed 42"
        }
      },
      {
        "box" : {
          ...
          "numoutlets" : 1,
          "outlettype" : [""],
          "patching_rect" : [300.0, 300.0, 70.0, 22.0],
          "text" : "randomize"
        }
      },
      {
