...
class bbb_noise_turbulence : public c74::min::object<bbb_noise_turbulence> {
public:
	MIN_DESCRIPTION{"Turbulence noise generator"};
	MIN_TAGS{"noise, turbulence, fractal, procedural"};
	MIN_AUTHOR{"2bit"};
...
MIN_EXTERNAL(bbb_noise_turbulence);
